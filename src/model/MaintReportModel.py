...
class Report(BaseModel):
    ...
    def __init__(self, request_info: MaintenanceRequest=None,verification_number: str=None,maintenance: list=None, contractorId: str=None, materialcost: int=None, salary: int=None, contractorsfee: float=None, finish_at: str=None) -> None:
        super().__init__()
